...
/***/ function(module, exports) {
	...
	var pauseScreen = exports.pauseScreen = function pauseScreen() {
	  var pauseText = new createjs.Text("    Get to the top! \n         Controls: \n [<-] [SPACE-BAR] [->]", "bold 25px Bungee Inline", "white");
	...
	var reachTop = exports.reachTop = function reachTop() {
	  var reachTopText = new createjs.Text("Get back to the bottom!", "bold 25px Bungee Inline", "white");
	};
